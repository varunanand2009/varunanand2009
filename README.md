...
📍 India | Open to work as per US and Europe TZ |

---

## 🧑‍💻 About Me
- 5+ years in IT & Telecom
- Strong Linux Administration (RHEL, Rocky, SUSE, Ubuntu)
- Transitioning into DevOps / Platform Engineering Role
- Experience with enterprise servers & production environments

---

## 🔧 Core Skills
- **Linux**: RHEL 7/8/9, Rocky Linux, SUSE, Ubuntu 
- **DevOps**: Git, GitHub, Jenkins, Docker, Kubernetes  
- **Cloud**: AWS, Azure  
- **Automation**: Ansible, Bash, Terraform, Python  
- **HA & Clusters**: Pacemaker, SAP HANA, Veritas, PCS  
